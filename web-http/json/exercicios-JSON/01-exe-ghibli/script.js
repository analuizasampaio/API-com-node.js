...
//FOR  (variavel contador ; limite; passo do contador)
for(let i=0; i <= jsonDeFilmes.length-1; i++){
  let filme = jsonDeFilmes[i] //cada item da lista sera "filme"

  console.log(filme.title) //titulo do filme
  console.log(filme.description)//descri do filme
